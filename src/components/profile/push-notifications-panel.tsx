    ...
    ui === 'active' ? (
      <>
        ...
        <span className="text-pretty">
          לבדיקה: בקשו מדייר <strong className="font-semibold">אחר</strong> בבניין שיפרסם פוסט, או התחברו מחשבון נוסף — על{' '}
          <strong className="font-semibold">הפוסט שלכם</strong> לא תישלח התראה אליכם.
        </span>
      </>
    ) : ui === 'blocked' ? (
      <>
      ...
      <>
        אשרו קבלת עדכוני פוש מהאפליקציה לנייד. לא תופיע התראה כשאתם מפרסמים בעצמכם — לבדיקה צריך שמישהו אחר בבניין יפרסם או שיצרתם חשבון נוסף.
      </>
    )
